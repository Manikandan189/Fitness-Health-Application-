...
public class nutriprotein1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        headn.setText(R.string.what2);
        head1n=findViewById(R.id.head1n);
        head1n.setText(R.string.what3);
        does1n=findViewById(R.id.does1n);
        does1n.setText(R.string.does2);
        process1n=findViewById(R.id.process1n);
        process1n.setText(R.string.processed2);
        day1n=findViewById(R.id.day1n);
        day1n.setText(R.string.per2);
        take1n=findViewById(R.id.take1n);
        take1n.setText(R.string.take2);
        ImageView img1=findViewById(R.id.imagen);
        img1.setImageResource(R.drawable.img_62);
        ImageView img2=findViewById(R.id.image1n);
        img2.setImageResource(R.drawable.img_63);
