...
public class nutianti1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        headn.setText(R.string.antioxidants_what);
        head1n=findViewById(R.id.head1n);
        head1n.setText(R.string.antioxidants_whatInfo);
        does1n=findViewById(R.id.does1n);
        does1n.setText(R.string.antioxidants_does);
        process1n=findViewById(R.id.process1n);
        process1n.setText(R.string.antioxidants_process);
        day1n=findViewById(R.id.day1n);
        day1n.setText(R.string.antioxidants_perday);
        take1n=findViewById(R.id.take1n);
        take1n.setText(R.string.antioxidants_take);
        ImageView img1=findViewById(R.id.imagen);
        img1.setImageResource(R.drawable.img_71);
