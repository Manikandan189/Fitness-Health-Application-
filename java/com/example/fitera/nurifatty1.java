...
public class nurifatty1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        headn.setText(R.string.efas_what);
        head1n=findViewById(R.id.head1n);
        head1n.setText(R.string.efas_whatInfo);
        does1n=findViewById(R.id.does1n);
        does1n.setText(R.string.efas_does);
        process1n=findViewById(R.id.process1n);
        process1n.setText(R.string.efas_process);
        day1n=findViewById(R.id.day1n);
        day1n.setText(R.string.efas_perday);
        take1n=findViewById(R.id.take1n);
        take1n.setText(R.string.efas_take);
        ImageView img1=findViewById(R.id.imagen);
        img1.setImageResource(R.drawable.img_74);
